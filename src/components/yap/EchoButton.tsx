      ...
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            ...
            <button
              className={`transition-all hover:scale-[1.2] hover:text-yap-peri-500 hover:drop-shadow-echo active:scale-[0.95] ${on ? 'text-yap-peri-500 drop-shadow-echo' : 'text-zinc-600'} flex items-center gap-1`}
