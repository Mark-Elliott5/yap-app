        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Link
              ...
              className={`flex items-center gap-1 text-zinc-500 transition-[transform,filter] hover:scale-[1.2] hover:text-yap-blue-500 hover:drop-shadow-reply active:scale-[0.95] dark:text-zinc-600`}
