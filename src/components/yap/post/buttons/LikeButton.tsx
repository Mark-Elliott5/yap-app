      ...
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            ...
            <button
              className={`transition-[transform,filter] ease-linear hover:scale-[1.2] hover:text-yap-red-500 hover:drop-shadow-heart active:scale-[0.95] active:animate-none ${on ? 'text-yap-red-500 drop-shadow-heart' : 'text-zinc-500 dark:text-zinc-600'} flex items-center gap-1`}
